          ...
          <section key={coop.id} style={{ marginTop: "1.5rem" }}>
                  ...
                  <div style={{ marginTop: "0.4rem" }}>
                    {coop.device ? (
                      <>
                        ...
                        {t?.simulated && <span className="sim-badge inline">SIMULATED DATA</span>}
                      </>
                    ) : (
                      <>
            ...
            {t?.simulated && (
              <p className="sim-note">
                These readings are generated by firmware built with <code>SIMULATE_SENSORS</code>. No sensors are
                connected to this device — do not use them for any welfare or stocking decision.
              </p>
            )}
            {t && (
              <div className={`sensor-grid${t.simulated ? " simulated" : ""}`} style={{ marginTop: "1rem" }}>
